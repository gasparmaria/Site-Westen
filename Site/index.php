        ...
        <section class="container-conteudo">
            <div class="container-cards-home">
                <div class="cards-home__item">
                    ...
                    <h1 class="cards-home__item-titulo">Aplicações e Softwares</h1>
                    <p class="cards-home__item-texto">
                        Os softwares são projetados para fazer o trabalho árduo,
                        e você terá mais do que facildade para utilizá-los. Tenha um software
                        otimizado, seguro e intuitivo.
                    </p>    
                </div>
                ...
                <div class="cards-home__item">
                    ...
                    <h1 class="cards-home__item-titulo">Designs Únicos</h1>
                    <p class="cards-home__item-texto">
                        Prezamos não somente pelas funcionalidades da aplicação, assim como também
                        pelos diversos aspectos visuais, implementados para melhorar o máximo possível a
                ...
                <div class="cards-home__item">
                    ...
                    <h1 class="cards-home__item-titulo">Melhor Tecnologia</h1>
                    <p class="cards-home__item-texto">
                        Utilizando os melhores recursos e boas práticas, garantimos performance, segurança
                        e qualidade ao produto final. Atendemos as amplas necessidades fornecendo sistemas e serviços
                        flexíveis com fácil manutenção.

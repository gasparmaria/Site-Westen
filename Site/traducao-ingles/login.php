...
<body>
    <a id="voltar-home" href="index.php">Return<span class="background-voltar"><span></a>
    <div class="body-login">
        <form id="formulario-login-validate" action="formulario/login-form.php" class="formulario-login" method="POST">
            <div class="formulario-login__campos">
                ...
                <input name="inputEmail" type="email" class="formulario-login__input" placeholder="Type your email" required>
                <input name="inputSenha" type="password" class="formulario-login__input" placeholder="Type your password" required>
                <button type="submit" class="formulario-login__entrar">Login</button>  
            </div>

<footer class="rodape">
        <div class="container">
            <div class="rodape-container-fluid">
                <section class="rodape-item">
                    <h1 class="rodape-item__titulo">GET TO KNOW US</h1>
                    <a class="rodape-item__link" href="portfolio.php">Projects</a>
                    <a class="rodape-item__link" href="index.php">General features</a>
                </section>
                <hr class="linha-rodape">
                <section class="rodape-item">
                    <h1 class="rodape-item__titulo">SUPORTE</h1>
                    <a class="rodape-item__link" href="contato.php">Contact</a>
                </section>
                <hr class="linha-rodape">
                <section class="rodape-item">
                    <h1 class="rodape-item__titulo">EMPRESA</h1>
                    <a class="rodape-item__link" href="empresa.php">History</a>
                </section>
                <hr class="linha-rodape">
            </div>
        ...
        <div class="container">
            <div class="container-copyright">
                <span class="copyright">Copyright &copy;<?php $date = date('Y'); echo $date; ?> - All rights reserved</span>
                <span class="termos-de-uso"><a href="#">Terms of use</a</span>
            </div>
        </div>
    </footer>
